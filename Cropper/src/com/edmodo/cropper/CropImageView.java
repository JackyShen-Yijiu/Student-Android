...
import com.edmodo.cropper.cropwindow.OnPreviewListener;
...
public class CropImageView extends FrameLayout {
	...
	public PreviewListener getListener() {
		return listener;
	}

	public void setOnPreviewListener(PreviewListener listener) {
	...
	private void init(Context context) {
		...
		mCropOverlayView.setPreviewListener(new OnPreviewListener() {
	...
	public void onImageSeleceChange() {
		if (listener != null) {
			listener.onImageSelectChanged();
		}
	}
