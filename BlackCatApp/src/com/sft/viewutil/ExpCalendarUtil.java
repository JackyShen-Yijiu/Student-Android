...
public class ExpCalendarUtil {
	...
	// calendar.set(CellConfig.m2wPointDate.getYear(),
	// CellConfig.m2wPointDate.getMonth() - 1,
	// CellConfig.m2wPointDate.getDay());
	// int distance = absPos - CellConfig.Week2MonthPos;
	// calendar.add(Calendar.MONTH, distance);
	// Log.i("ExpDateData month", CellConfig.m2wPointDate.toString()
	// + " distance :" + distance);
	// Log.i("ExpDateData month",
	// calendar.get(Calendar.YEAR) + "年"
	// + calendar.get(Calendar.MONTH));
	// return new DateData(calendar.get(Calendar.YEAR),
	...
	// // CellConfig.w2mPointDate.getMonth() - 1,
	// // CellConfig.w2mPointDate.getDay());
